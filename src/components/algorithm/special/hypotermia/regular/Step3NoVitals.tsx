...
const pageText = {
  sk: {
    ...
    treatmentItems: [
      ...
      "Ak je teplota jadra 30-35 °C, predĺžte intervaly podávania adrenalínu na 6-10 minút.",
  ...
  en: {
    ...
    treatmentItems: [
      ...
      "At a core temperature of 30-35 °C, extend the intervals for administering adrenaline to 6-10 minutes.",

...
export type NewbornSheetColors = {
  background: string;
...
type ResultsCardProps = {
  title: string;
  items: NewbornResultItem[];
  colors: NewbornSheetColors;
};

type ResultRowProps = {
  item: NewbornResultItem;
  colors: NewbornSheetColors;
};

export const newbornSheetColors: {
  light: NewbornSheetColors;
  dark: NewbornSheetColors;
} = {
  light: {
    background: "#e6e7ee",
